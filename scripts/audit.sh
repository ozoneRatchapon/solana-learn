...
# 2026-08-05: ไล่เติมครบ 180/180 แล้ว ดันเพดานขึ้น 100 — จากนี้ entry ที่ไม่มี note
# ทำให้ audit ไม่ผ่าน ไม่ใช่แค่เตือน ซึ่งตรงกับที่ add.sh บังคับ -m อยู่แล้ว
NOTE_FLOOR="${NOTE_FLOOR:-100}"
